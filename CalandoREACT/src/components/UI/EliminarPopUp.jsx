    ...
    return (
        ...
        <div className="fixed inset-0 flex items-center justify-center">
            ...
            <div className="bg-white rounded-lg overflow-hidden p-0 max-w-md w-full mx-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-5">
                    <h1 className="text-center text-2xl">¿Esta seguro que desea eliminar la liga? 
                        <p className="font-bold">{liga.nombreLiga}</p>
                        <p className="font-bold">Id: {liga.id}</p>
                    </h1>
                    <div className="flex justify-center space-x-20">
                        ...
                        <button className="bg-green-500 text-white font-bold font-bold px-4 py-2 rounded-xl hover:bg-green-600 mt-5" onClick={onConfirmar}>
                         Aceptar
                        </button>
                    </div>
                </div>
